...
<html>
    ...
    <body>
	    ...
	    <tr><td>Foto Ktp</td><td><img width="25%" src=<?php echo base_url('dokumen/ktp/'.$foto_ktp) ?> /></td></tr>
	    <tr><td>Foto Ijazah</td><td><img width="25%" src=<?php echo base_url('dokumen/ijazah/'.$foto_ijazah) ?> /></td></tr>
	    <tr><td>Foto Profil</td><td><img width="25%" src=<?php echo base_url('dokumen/profil/'.$foto_profil) ?> /></td></tr>
