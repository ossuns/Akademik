...
class Tentor extends CI_Controller
{
    ...
    public function read($id) 
    {
        ...
        'alamat_tentor' => $row->alamat_tentor,
    ...
    public function create() 
    {
        ...
        'alamat_tentor' => set_value('alamat_tentor'),
    ...
    public function create_action() 
    {
        ...
        'alamat_tentor' => $this->input->post('alamat_tentor',TRUE),
    ...
    public function update($id) 
    {
        ...
        'alamat_tentor' => set_value('alamat_tentor', $row->alamat_tentor),
        ...
        'id_provinsi' => set_value('id_provinsi', $row->id_provinsi),
          ...
          //  $this->load->view('tentor/tentor_form', $data);
        $this->template->set('title', '');
        $this->template->load('index2', 'contents' , 'tentor/tentor_profile',$data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('tentor'));
        }
    ...
    public function update_action() 
    {
        ...
        if ($_FILES['foto_ktp']['name']!=null || $_FILES['foto_ktp']['name']!='') {
                    $config['upload_path']          = './dokumen/ktp/';
        ...
        if ($_FILES['foto_ijazah']['name']!=null || $_FILES['foto_ijazah']['name']!='') {
                    ...
                    if (!$this->upload->do_upload('foto_ijazah')){    
                       // $this->update();
                         ...
                         $data['foto_ijazah'] = $this->upload->data('file_name');;
                    }
                }
            if ($_FILES['foto_profil']['name']!=null || $_FILES['foto_profil']['name']!='') {
                    $config['upload_path']          = './dokumen/profil/';
                    $config['allowed_types']        = 'jpeg|png|jpg';
                    $config['overwrite']            = true;
                    $this->load->library('upload', $config);
                    $this->upload->initialize($config);
            ...
            $this->Tentor_model->update($this->input->post('id_tentor'),$data);
            $this->session->set_flashdata('message', 'Update Record Success');
            redirect(base_url('tentor/read/'.$this->input->post('id_tentor')));
        }
    }
    ...
    $this->form_validation->set_rules('foto_ktp', 'foto ktp', 'trim');
    $this->form_validation->set_rules('foto_ijazah', 'foto ijazah', 'trim');
    ...
    foreach ($this->Tentor_model->get_all() as $data) {
        ...
        xlsWriteLabel($tablebody, $kolombody++, $data->alamat_tentor);
